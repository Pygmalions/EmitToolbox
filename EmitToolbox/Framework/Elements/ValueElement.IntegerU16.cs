...
{
    public static VariableElement<short> ToInteger16(this ValueElement<ushort> target)
    {
    ...
    public static VariableElement<int> ToInteger32(this ValueElement<ushort> target)
    {
    ...
    public static VariableElement<uint> ToIntegerU32(this ValueElement<ushort> target)
    {
    ...
    public static VariableElement<long> ToInteger64(this ValueElement<ushort> target)
    {
    ...
    public static VariableElement<ulong> ToIntegerU64(this ValueElement<ushort> target)
    {
