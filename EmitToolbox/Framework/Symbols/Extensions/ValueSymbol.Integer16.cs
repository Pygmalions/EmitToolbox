...
public static class ValueSymbolInteger16Extensions
{
    public static VariableSymbol<ushort> ToIntegerU16(this ValueSymbol<short> target)
    {
    ...
    public static VariableSymbol<int> ToInteger32(this ValueSymbol<short> target)
    {
    ...
    public static VariableSymbol<uint> ToIntegerU32(this ValueSymbol<short> target)
    {
