...
public static class ValueSymbolIntegerU16Extensions
{
    ...
    public static VariableSymbol<int> ToInteger32(this ValueSymbol<ushort> target)
    {
    ...
    public static VariableSymbol<uint> ToIntegerU32(this ValueSymbol<ushort> target)
    {
    ...
    public static VariableSymbol<long> ToInteger64(this ValueSymbol<ushort> target)
    {
    ...
    public static VariableSymbol<ulong> ToIntegerU64(this ValueSymbol<ushort> target)
    {
