...
{
    public static VariableSymbol<ushort> ToIntegerU16(this ISymbol<short> target)
    {
    ...
    public static VariableSymbol<int> ToInteger32(this ISymbol<short> target)
    {
    ...
    public static VariableSymbol<uint> ToIntegerU32(this ISymbol<short> target)
    {
